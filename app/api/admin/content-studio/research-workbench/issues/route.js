...
function buildIssuePrompt({ categories, recency, excludeHistory }) {
  ...
  return [
    ...
    '① 반전/역설 우선: 기존 통념과 반대되는 행동을 한 이슈 최우선. 동일 주체(같은 사람/회사)가 짧은 기간 내 모순된 행동을 한 사건은 매우 강한 후보. reversal_score 4-5로 채점.',
    '② 좁은 독자 호출 가능: "취업 준비생", "직장인", "혼자 마케팅 챙기는 사장님"처럼 특정 상황을 한 문장으로 호출 가능한 이슈 우선. audience_callout_candidate에 그 독자를 명시.',
    '③ 한국 관점 번역 가능: 해외 이슈도 한국 직장인·사업자 관점에서 "그래서 나는?" 번역 가능한 이슈 우선. korean_hook에 한국 독자 관점 번역 힌트 1문장을 반드시 적을 것.',
    ...
    '      "reversal_score": 3,',
    '      "internal_contradiction": "동일 주체가 짧은 기간 내 모순된 행동을 했다면 여기에 서술. 없으면 빈 문자열",',
    '      "audience_callout_candidate": "취업 준비하는 사람 | 직장인 | 혼자 마케팅 챙기는 사장님 등 좁은 독자 1문장",',
    '      "korean_hook": "한국 독자 관점에서 이 이슈의 핵심 한 줄 번역. 예: 5년 차 경험이 22살 AI 친숙도보다 싸게 거래되는 시장이 시작됨"',
    '    }',
    '  ]',
    '}',
    '',
    ...
    '- audience_callout_candidate: 이 이슈로 글을 쓸 때 첫 줄에 호출할 수 있는 좁은 독자. "취업 준비하는 사람", "직장인", "사장님" 수준으로 좁게.',
