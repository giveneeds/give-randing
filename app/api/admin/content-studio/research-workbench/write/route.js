...
function buildWriterPrompt({ contentPlan, evidenceSnapshot, referenceContext }) {
  ...
  if (isIssueExplainer) {
    ...
    return [
      ...
      '- 포스트 개수는 소재에 따라 다릅니다. 뉴스/릴리즈/규제 사건은 보통 7~8개, 전문가 발언/팁/개념 해설 이슈는 10~15개까지 허용합니다.',
      '- 전문가 발언/팁 이슈는 짧은 뉴스 요약으로 끝내지 마세요. 한 문장이나 조언이 왜 중요한지 끝까지 풀어야 합니다.',
      ...
      '',
      'Beat 운영 규칙:',
      '- beat 개수와 post 개수를 1:1로 맞추지 않아도 됩니다. 뉴스/릴리즈/규제 사건은 최종 post 수를 7~8개로 조정하세요. 전문가 발언/팁 이슈는 논리 흐름이 살아 있으면 10~15개까지 허용합니다.',
      ...
      '- 뉴스형 7~8개 구성 예: 1 멈추는 장면, 2 원천 디테일, 3 누가/무엇을 했나, 4 왜 한 번짜리가 아닌가, 5 구조적 반전, 6 숫자/반응/시장 근거, 7 불확실성/주의점, 8 독자 결론/출처.',
      '- 전문가 팁형 10~15개 구성 예: 1 강한 첫 말, 2 진짜 질문, 3 원천 장면, 4 핵심 주장, 5 흔한 오해, 6 개념 작동 방식, 7 끝까지 봐야 하는 이유, 8 일상 장면, 9 중간 요약, 10 검증/반론, 11 실제 적용, 12 오늘 할 행동, 13 출처.',
