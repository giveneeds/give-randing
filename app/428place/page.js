    ...
    <main className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 selection:bg-zinc-900 selection:text-white dark:selection:bg-white dark:selection:text-zinc-900 [word-break:keep-all] [overflow-wrap:break-word]">
      ...
      <Section number="03" eyebrow="당장 이번 주">
        ...
        <div className="space-y-4 mt-8">
          ...
          <ActionCard
            num="03"
            title="플레이스 안에서 손님이 &lsquo;구경하고 머물게&rsquo; 설계됐나"
            desc="버튼 노출 위치는 네이버가 자동으로 정해요. 우리가 할 일은 우리가 직접 채울 수 있는 항목(소개글·대표키워드·메뉴·소식·사진)에 다양한 키워드를 골고루 녹여서, 손님이 페이지 안에서 충분히 둘러볼 거리를 만들어 주는 것."
            checks={[
              '소개글에 동네·업종·대표 메뉴/서비스 키워드를 자연스럽게 분산',
              '메뉴·서비스 설명에도 검색어가 들어가도록 (이름만 X, 설명까지 O)',
              '소식·사진을 꾸준히 올려 체류시간·재방문 신호 만들기',
              '대표키워드 슬롯은 핵심·롱테일을 섞어 채우기',
            ]}
            outro="버튼이 보이고 안 보이고는 네이버가 알아서 판단해요. 우리는 &lsquo;검색되고 머물게 만드는 콘텐츠&rsquo;에 집중하면 됩니다."
          />
        </div>
      </Section>
