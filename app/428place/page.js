    ...
    <main className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 selection:bg-zinc-900 selection:text-white dark:selection:bg-white dark:selection:text-zinc-900">
      ...
      >
        <div className="max-w-5xl mx-auto px-5 sm:px-8 h-14 flex items-center justify-between">
          <a href="/" className="flex items-center gap-2 group">
            ...
            <span className="hidden sm:inline-block text-[10px] tracking-widest text-zinc-400 dark:text-zinc-500 uppercase">
              · 428 Place Guide
            </span>
          </a>
      ...
      <section className="relative pt-36 pb-20 sm:pt-44 sm:pb-28 px-5 sm:px-8 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-zinc-200 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur text-[11px] tracking-widest font-bold uppercase text-zinc-600 dark:text-zinc-300 mb-8">
          ...
          <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-2xl mx-auto mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 px-6 py-3.5 rounded-xl text-sm font-bold tracking-wide hover:scale-[1.02] active:scale-[0.98] transition-transform"
            >
              <Search size={16} />
              내 가게 순위 30초 진단
              <ArrowRight size={15} />
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 text-zinc-900 dark:text-white px-6 py-3.5 rounded-xl text-sm font-bold tracking-wide hover:border-zinc-900 dark:hover:border-white transition"
            >
          ...
          <div className="mt-12 flex items-center justify-center gap-5 text-[11px] tracking-widest font-bold uppercase text-zinc-400 dark:text-zinc-500">
            <span>읽는데 5–10분</span>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 dark:from-amber-950/30 dark:via-orange-950/20 dark:to-rose-950/30 border border-amber-200/80 dark:border-amber-500/20 p-6 sm:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-[11px] tracking-widest font-bold uppercase text-amber-700 dark:text-amber-400 mb-1.5">
                  먼저 알려드릴 것
                </p>
                <h3 className="text-lg sm:text-xl font-black tracking-tight mb-2 text-zinc-900 dark:text-white">
                  4월 29일, 비공개 오픈채팅방을 엽니다
                </h3>
                <p className="text-sm sm:text-[15px] text-zinc-700 dark:text-zinc-300 leading-relaxed mb-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-amber-700 dark:text-amber-300 text-sm font-bold hover:gap-2.5 transition-all"
                >
                  오픈채팅 들어가기
      ...
      <Section number="00" eyebrow="시작 전 30초">
        ...
        >
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="text-[10px] tracking-widest font-bold uppercase opacity-60 mb-2">
                Free Tool
              </div>
              <div className="text-lg sm:text-xl font-black tracking-tight">
                내 가게 순위 체크하기
              </div>
              <div className="text-xs sm:text-sm opacity-70 mt-1.5">
        ...
        <p className="text-sm sm:text-[15px] text-zinc-600 dark:text-zinc-400 mt-8 mb-5">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {TYPES.map((t) => (
            ...
            >
              <div className={`inline-flex items-center gap-2 text-[11px] tracking-widest font-black uppercase mb-2 ${t.tag}`}>
      ...
      <Section number="01" eyebrow="지금 무슨 일이">
        ...
        <div className="my-10 p-7 sm:p-10 rounded-2xl border border-zinc-900 dark:border-white bg-zinc-50 dark:bg-zinc-900">
          <div className="text-[10px] tracking-widest font-black uppercase text-zinc-500 dark:text-zinc-400 mb-4">
            한 줄로 정리하면
          </div>
      ...
      <Section eyebrow="업종별로 다름">
        ...
        <div className="grid lg:grid-cols-2 gap-5 mt-8">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-zinc-200 dark:border-white/10 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/20 dark:to-amber-950/10 p-7">
            ...
            <div className="text-[11px] tracking-widest font-bold uppercase text-orange-600 dark:text-orange-400 mb-2">
              Food & Bev
            </div>
            ...
            <div className="mt-5 pt-5 border-t border-orange-200/60 dark:border-orange-500/10 text-[13px] text-zinc-700 dark:text-zinc-300">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-zinc-200 dark:border-white/10 bg-gradient-to-br from-violet-50 to-indigo-50 dark:from-violet-950/20 dark:to-indigo-950/10 p-7">
            <div className="text-3xl mb-3">💇 💪 💅 🏥</div>
            <div className="text-[11px] tracking-widest font-bold uppercase text-violet-600 dark:text-violet-400 mb-2">
            ...
            <div className="mt-5 pt-5 border-t border-violet-200/60 dark:border-violet-500/10 text-[13px] text-zinc-700 dark:text-zinc-300">
      ...
      <Section eyebrow="다른 곳이 안 알려주는 진짜 핵심">
        <div className="rounded-3xl bg-zinc-900 dark:bg-zinc-900 border border-zinc-800 dark:border-white/10 text-white p-7 sm:p-12 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 bg-white/5 backdrop-blur text-[10px] tracking-widest font-bold uppercase mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              <div className="rounded-xl border border-rose-500/30 bg-rose-500/10 p-5">
                <div className="text-[11px] tracking-widest font-bold uppercase text-rose-300 mb-2">
                  ❌ 한 가지만 쓰면
                </div>
              ...
              <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-5">
                <div className="text-[11px] tracking-widest font-bold uppercase text-emerald-300 mb-2">
                  ✅ 여러 통로를 번갈아
                </div>
                <p className="text-sm text-zinc-200 leading-relaxed">
            ...
            <div className="rounded-2xl border border-white/10 overflow-hidden bg-zinc-950/40">
              <div className="grid grid-cols-12 px-5 py-3 text-[10px] tracking-widest font-bold uppercase text-zinc-400 border-b border-white/10 bg-white/[0.02]">
              ...
              {CHANNELS.map((c) => (
                <div
                  key={c.name}
                  className="grid grid-cols-12 px-5 py-4 text-sm border-b border-white/5 last:border-0 items-center"
                >
                  ...
                  <div className="col-span-12 sm:col-span-6 text-zinc-400 mt-1.5 sm:mt-0 text-[13px]">
                    {c.how}
                  </div>
            ...
            <div className="mt-8 p-5 sm:p-6 rounded-xl bg-white/5 border border-white/10">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm sm:text-[15px] text-zinc-300 leading-relaxed italic">
            ...
            <div className="mt-6 p-5 rounded-xl bg-amber-500/10 border border-amber-500/30">
              <div className="text-[11px] tracking-widest font-bold uppercase text-amber-300 mb-2">
      ...
      <Section eyebrow="키워드도 여러 갈래로">
        ...
        <div className="mt-12 rounded-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 p-7">
          <div className="flex items-center gap-2 text-[11px] tracking-widest font-black uppercase text-zinc-500 dark:text-zinc-400 mb-4">
            <MessageCircle size={13} />
            어제 받은 DM
          </div>
          <p className="text-base sm:text-lg text-zinc-800 dark:text-zinc-200 leading-relaxed italic mb-5">
          ...
          <div className="pt-5 border-t border-zinc-200 dark:border-white/10">
            <div className="text-[11px] tracking-widest font-black uppercase text-violet-600 dark:text-violet-400 mb-2">
              → 답
            </div>
            <p className="text-sm sm:text-[15px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
      ...
      <Section number="05" eyebrow="중장기 체질 개선">
        ...
        <div className="mt-8 rounded-2xl border border-zinc-200 dark:border-white/10 overflow-hidden bg-white dark:bg-zinc-900">
          {ROUTINES.map((r, i) => (
            ...
            >
              <div className="col-span-1 text-[11px] tracking-widest font-black text-zinc-400 dark:text-zinc-600">
                0{i + 1}
              </div>
              <div className="col-span-11 sm:col-span-4">
                <div className="flex items-center gap-2">
                  <r.icon size={14} className="text-violet-500 dark:text-violet-400 shrink-0" />
                  <h4 className="font-black text-zinc-900 dark:text-white text-[15px]">
                    {r.title}
                  </h4>
                </div>
              </div>
              <div className="col-span-12 sm:col-span-7 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                {r.detail}
              </div>
            </div>
          ))}
      ...
      <section className="px-5 sm:px-8 py-20 sm:py-28 bg-zinc-50 dark:bg-zinc-900/40 border-y border-zinc-200 dark:border-white/5">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-950 text-[11px] tracking-widest font-bold uppercase text-zinc-600 dark:text-zinc-300 mb-5">
            ...
            {ROUTES.map((r) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`text-[11px] tracking-widest font-black uppercase ${r.tagColor}`}>
                    {r.tag}
                  </span>
                </div>
                ...
                <ul className="space-y-1.5 text-[13px] text-zinc-700 dark:text-zinc-300 mb-5">
                  {r.bullets.map((b, i) => (
                    <li key={i} className="flex gap-2">
                ...
                <div className={`inline-flex items-center gap-1.5 text-sm font-bold ${r.iconColor} group-hover:gap-2.5 transition-all`}>
                  {r.cta}
                  <ArrowUpRight size={14} />
                </div>
              </a>
          ...
          <div className="mt-8 p-5 rounded-xl bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-500/20 text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed">
      ...
      <section className="px-5 sm:px-8 py-20 sm:py-28">
        <div className="max-w-3xl mx-auto">
          <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900 p-7 mb-10">
            ...
            <p className="text-base text-zinc-800 dark:text-zinc-200 leading-relaxed italic mb-5">
      ...
      <div className="max-w-3xl mx-auto">
        {(number || eyebrow) && (
          <div className="flex items-center gap-3 mb-5">
            {number && (
              <span className="text-[11px] tracking-widest font-black text-zinc-400 dark:text-zinc-600 tabular-nums">
                / {number}
              </span>
            )}
            {eyebrow && (
              <span className="text-[11px] tracking-widest font-black uppercase text-violet-600 dark:text-violet-400">
                {eyebrow}
              </span>
            )}
          </div>
...
function Note({ children, tone = 'zinc', icon }) {
  ...
  return (
    <div className={`mt-8 rounded-xl border p-5 sm:p-6 text-sm leading-relaxed ${tones[tone]}`}>
      ...
      <div className="flex items-start gap-5">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-black text-zinc-900 dark:text-white">{title}</h3>
          </div>
...
function KeywordCard({ emoji, title, keywords, footer }) {
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900 p-7">
      ...
      <h3 className="font-black text-lg text-zinc-900 dark:text-white mb-5">{title}</h3>
      <ul className="space-y-2.5 mb-5">
        {keywords.map((k, i) => (
          <li key={i} className="flex items-center justify-between gap-3 text-sm">
            <span className="text-zinc-800 dark:text-zinc-200 font-medium">{k.kw}</span>
            <span className="text-[10px] tracking-widest font-bold uppercase text-zinc-400 dark:text-zinc-500 shrink-0">
              {k.tag}
            </span>
          </li>
        ))}
      </ul>
      <div className="pt-4 border-t border-zinc-200 dark:border-white/10 text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed">
        → {footer}
      </div>
    </div>
  );
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900 overflow-hidden">
      <div className="bg-zinc-900 dark:bg-zinc-950 p-5 sm:p-6 text-white border-b border-zinc-800 dark:border-white/10">
        <div className="text-[10px] tracking-widest font-black uppercase text-violet-300 mb-2">
          {tag}
        </div>
      ...
      <div className="p-5 sm:p-7 space-y-5">
        ...
        <div>
          <div className="text-[10px] tracking-widest font-black uppercase text-violet-600 dark:text-violet-400 mb-2.5">
            뭘 했나
          </div>
...
function CaseRow({ label, body, accent }) {
  ...
  return (
    <div>
      <div className={`text-[10px] tracking-widest font-black uppercase mb-1.5 ${colors[accent]}`}>
        {label}
      </div>
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900 p-6 sm:p-7">
      <div className="flex items-start gap-5 mb-5">
        <div className="shrink-0 text-[11px] tracking-widest font-black text-violet-600 dark:text-violet-400 tabular-nums pt-1">
          / {num}
        </div>
        <div className="flex-1">
          <h3 className="font-black text-lg text-zinc-900 dark:text-white mb-2 leading-snug">
            {title}
          </h3>
      ...
      <div className="pl-9">
        <div className="rounded-lg bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-200 dark:border-white/5 p-4 text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed italic">
          {outro}
        </div>
      </div>
    </div>
  ...
  return (
    <div className={`rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900 p-7 ring-4 ${c.ring}`}>
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="font-black text-zinc-900 dark:text-white leading-tight">{label}</h3>
      </div>
      <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed mb-5">
        <span className="font-bold text-zinc-900 dark:text-white">원인:</span> {cause}
      </p>
      <div className="mb-5">
        <div className={`text-[10px] tracking-widest font-black uppercase mb-2 ${c.text}`}>
          우선순위
        </div>
      ...
      <div className="rounded-lg bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-200 dark:border-white/5 p-4 text-[13px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
        → {outcome}
      </div>
    </div>
  );
