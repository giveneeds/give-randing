import { isAdminOrPreviewPath, isCurrentAdminOrPreviewPath } from '@/lib/adminPreviewPaths';
...
export function isAdminPath(pathname) {
  return isAdminOrPreviewPath(pathname);
}

export function initMetaPixel() {
  if (!isMetaPixelEnabled()) return false;
  if (isCurrentAdminOrPreviewPath()) return false;
