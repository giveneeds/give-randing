...
export const DUMMY_SERVICE_PRODUCTS = [
  // ── ADS: Strategic Ads ──
  { id: 'v1', title: 'Cafe Viral', desc: '전략적 커뮤니티 침투를 통한 입소문 극대화', category: 'ADS', slug: 'cafeviral', color: '#1E4181' },
  { id: 'v2', title: 'Blog Marketing', desc: '검색 엔진의 최상단을 점유하는 브랜드 자산', category: 'ADS', slug: 'blogmarketing', color: '#1E4181' },
  { id: 'v3', title: 'Press Release', desc: '공신력 있는 매체를 통한 브랜드 신인도 확보', category: 'ADS', slug: 'pressrelease', color: '#1E4181' },
  { id: 'c1', title: 'Meta Ads', desc: '정교한 타겟팅으로 만드는 압도적 ROAS', category: 'ADS', slug: 'metaads', color: '#1E4181' },
  { id: 'c2', title: 'Powerlink Opt.', desc: '검색 인텐트를 즉각적인 구매로 전환', category: 'ADS', slug: 'powerlink', color: '#1E4181' },
  // ── GROWTH: Growth & Review ──
  { id: 'r1', title: 'Store Review', desc: '구매 결정의 마지막 관문을 여는 신뢰의 데이터', category: 'GROWTH', slug: 'storereview', color: '#16A34A' },
  { id: 'r2', title: 'Place Review', desc: '오프라인 방문을 결정짓는 지역 기반 평판 관리', category: 'GROWTH', slug: 'placereview', color: '#16A34A' },
  { id: 'r3', title: 'Channel Review', desc: '글로벌 및 멀티 채널 신뢰도 통합 관리', category: 'GROWTH', slug: 'channelreview', color: '#16A34A' },
  { id: 's1', title: 'SNS Growth', desc: '팬덤을 형성하는 강력한 브랜드 소셜 파워', category: 'GROWTH', slug: 'snsgrowth', color: '#16A34A' },
  { id: 's2', title: 'Experience Team', desc: '글로벌 타겟을 사로잡는 프리미엄 체험단', category: 'GROWTH', slug: 'globalexperience', color: '#16A34A' },
  // ── LOCAL: Local Optimize ──
  { id: 'l1', title: 'Store Optimize', desc: '노출 알고리즘 분석을 통한 스토어 상단 선점', category: 'LOCAL', slug: 'storeoptimize', color: '#71717A' },
  { id: 'l2', title: 'Place Optimize', desc: '내 주변 맛집/장소 검색 시 최상단 노출 기술', category: 'LOCAL', slug: 'placeoptimize', color: '#71717A' },
  { id: 'l3', title: '070 Opt. Service', desc: '지역 기반 통신 지표 최적화 및 연결률 강화', category: 'LOCAL', slug: '070service', color: '#71717A' },
  { id: 'l4', title: 'Kakao Map Exp.', desc: '국내 최대 지도 플랫폼 내 브랜드 인지도 확산', category: 'LOCAL', slug: 'kakaomap', color: '#71717A' },
  // ── TECH: Tech / Creative ──
  { id: 'a1', title: 'AI Auto Posting', desc: '24시간 멈추지 않는 지능형 콘텐츠 생산 엔진', category: 'TECH', slug: 'aiposting', color: '#18181B' },
  { id: 'p1', title: 'Premium Website', desc: '브랜드의 본질을 담은 독보적인 디지털 경험', category: 'TECH', slug: 'premiumweb', color: '#18181B' },
];
