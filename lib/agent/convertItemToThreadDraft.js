...
import { buildKnowledgeContext, getThreadsRealBodySamples } from '@/lib/knowledge/loader';
...
${variantToneBlock ? `[이 variant 전용 톤 샘플 — 너의 기본 AI 문체를 강제로 깨라. 이 글의 문장 길이·줄바꿈 호흡·반말/존댓말 비율·종결 다양성·이모지 사용·"?" 빈도를 *그대로* 흉내내라. 주제는 새로 쓰되 톤은 같게.]\n${variantToneBlock}\n\n` : ''}${knowledgeBlock ? `[참조 지식·거버넌스]\n${knowledgeBlock}\n\n` : ''}출력 형식: JSON 만. 후보 1개 객체만 반환한다(variants 배열·scores 없음). 형식:
{
