...
// DB 분석값이 아니라 원문/관찰 기록을 짧게 정리해 LLM 이 "이런 식으로 구성된다"를 읽게 한다.
export function getThreadsCuratedReferences() {
  return loadDoc('reference-data/threads-curated-reference-notes.md');
}
