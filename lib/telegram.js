...
const PERSONA_LABEL = {
  general: '🏪 작은 사업자/브랜드 운영',
  general: '🏪 작은 사업자/브랜드 운영',
  unknown: '⚪ 미상',
  restaurant_owner: '🏪 작은 사업자/브랜드 운영',
  clinic_owner: '🏪 작은 사업자/브랜드 운영',
  brand_operator: '🏪 작은 사업자/브랜드 운영',
  marketer: '🏪 작은 사업자/브랜드 운영',
  small_brand_owner: '🏪 작은 사업자/브랜드 운영',
  general_reader: '🏪 작은 사업자/브랜드 운영',
};
