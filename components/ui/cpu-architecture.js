...
/**
 * CpuArchitecture Component
 * 
 * @param {string} className - Optional tailwind classes
 * @param {string} width - SVG width
 * @param {string} height - SVG height
 * @param {string} text - Central text (Default: "CPU")
 * @param {boolean} showCpuConnections - Show pin connections
 * @param {number} lineMarkerSize - Size of path markers
 * @param {boolean} animateText - Animate text gradient
 * @param {boolean} animateLines - Animate path stroke
 * @param {boolean} animateMarkers - Animate markers
 */
