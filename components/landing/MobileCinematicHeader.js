...
export default function MobileCinematicHeader() {
  return (
    <section className="md:hidden bg-white dark:bg-zinc-950 overflow-hidden">
      <div className="relative min-h-[100svh] px-5 pt-28 pb-16 flex flex-col justify-center">
        <div className="pointer-events-none absolute top-24 left-1/2 h-56 w-56 -translate-x-1/2 rounded-full bg-blue-500/10 blur-3xl" />
        <p className="relative mb-5 text-center text-[10px] font-black uppercase tracking-[0.35em] text-blue-500">
          Intelligence System v3
        </p>
        <div className="relative mx-auto w-full max-w-[22rem] text-center text-[clamp(3.1rem,14vw,4.25rem)] leading-[0.9] font-black tracking-[-0.08em] text-zinc-900 dark:text-white uppercase whitespace-nowrap">
          GIVENEEDS
        </div>
        <p className="relative mx-auto mt-6 max-w-[18rem] text-center text-sm font-bold leading-relaxed text-zinc-500 dark:text-zinc-400 break-keep">
          데이터와 검색 흐름을 읽고, 브랜드가 필요한 마케팅 액션만 선명하게 설계합니다.
        </p>
        <div className="relative mx-auto mt-10 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.22em] text-zinc-400">
          Scroll to analyze
      ...
      <div className="px-4 pb-14">
        <div className="rounded-[2rem] border border-zinc-200 bg-white/90 p-4 shadow-[0_24px_80px_rgba(0,0,0,0.08)] dark:border-white/10 dark:bg-zinc-900/80">
